...
import store, {filterKeys} from '@/utils/store.ts'
</script>

<template>
  <div class="key-footer">
      <el-select v-model="store.db" filterable value-key="index" style="width: 100px">
      ...
      <el-button-group>
        ...
        <me-button tooltip="加载所有" icon="el-icon-download" type="warning"/>
      </el-button-group>
  </div>
</template>
